                ...
                $show.="<div class='col-md-6 col-lg-6'>";
                    $show.="<div class='single_delicious d-flex align-items-center'>";
                        $show.="<div class='thumb'>";
                            $show.="<img src='img/video.png' width=150px height=150px >";
                        $show.="</div>";
                        $show.="<div class='info'>";
                            $show.="<h4>".$list['header']."</h4>";
                            $show.="<p>".$list['description']."</p>";
                            $show.="<a href=$link>"."<span>"."Learn"."</span>"."</a>";
                        $show.="</div>";
                    $show.="</div>";
                $show.="</div>";
            }    
                ...
                <div class="row align-items-center">
                    <div class="col-xl-6 col-lg-6 col-md-6">
                        <div class="about_thumb2">
                            ...
                            <div class="img_2">
                                <img src="img/about/teacher.png" alt="" width="300px">
                            </div>
                        </div>
                    </div>
