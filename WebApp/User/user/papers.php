                ...
                $show.="<div class='col-md-6 col-lg-6'>";
                    $show.="<div class='single_delicious d-flex align-items-center'>";
                        $show.="<div class='thumb'>";
                            $show.="<img src='../../admin/uploadPapers/pdf.png' width=150px height=150px >";
                        $show.="</div>";
                        $show.="<div class='info'>";
                            $show.="<h3>".$list['header']."</h3>";
                            $show.="<p>".$list['description']."</p>";
                            $show.="<a href=\"views2.php?v_code={$list['id']}\">"."<input type='submit' class='btn btn-success' value='Download' name='download'>"."</a>";
                        $show.="</div>";
                    $show.="</div>";
                $show.="</div>";
            }    
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section_title text-center mb-80">
                        ...
                        <h2>දිවයිනේ ඇති හොදම Paper කට්ටල සහා පිළිතුරුපත් අන්තර්ගතය</h2>
                    </div>
                </div>
            </div>
            <div class="row">
