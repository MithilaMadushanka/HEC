<?php
      ...
      if (isset($_GET['video_id'])) {
          ...
          $query = "SELECT *FROM images WHERE id=$video_id";
          ...
          <div class="content-wrapper">
            ...
            <div class="row">
                  <div class="col-md-6 grid-margin stretch-card">
                      <div class="card">
                          <div class="card-body">
                              <h4 class="card-title">Update Video Details</h4>
                              <!-- <p class="card-description"> Horizontal form layout </p> -->
                              <br><br>
                              <form class="forms-sample" method="post" action="../php scripts/updateVideo.php" enctype="multipart/form-data">
                                    <?php  if($msg ==505):?>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="title" class="form-control" id="exampleInputUsername2" placeholder="Your video title" required value=<?php echo $title; ?>>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                          <label for="exampleInputEmail2" class="col-sm-3 col-form-label">Description</label>
                                          <div class="col-sm-9">
                                              <input type="text" name="description" class="form-control" id="exampleInputEmail2" placeholder="Your video Description" required value=<?php echo $description; ?>>
                                          </div>
                                    </div>
                                    <!-- <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="video_link" class="form-control" id="exampleInputUsername2" placeholder="Your Video link" required value=<?php echo $video_link; ?>>
                                        </div>
                                    </div>

                                    <button type="submit" class="btn btn-gradient-primary mr-2" name="update_video">Update</button>
