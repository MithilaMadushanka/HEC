                  ...
                  <div class="col-md-12 grid-margin stretch-card">
                      <div class="card">
                          <div class="card-body">
                              ...
                              <br><br>
                              <form class="forms-sample" method="post" action="../php scripts/updateMyAcc.php">
                                    <?php  if($msg ==505):?>
                                    ...
                                    <?php  if($msg ==508):?>
                                        <div class="alert alert-success" role="alert">
                                              Your Account change with Password Successfully!.
                                        </div>
                                    <?php endif; ?> 
                                    <?php  if($msg ==507):?>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="exampleInputUsername2" readonly value=<?php echo $name; ?> >
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                          <label for="exampleInputEmail2" class="col-sm-3 col-form-label">Email</label>
                                          <div class="col-sm-9">
                                              <input type="email" name="email" class="form-control" id="exampleInputEmail2" required value=<?php echo $email; ?>>
                                          </div>
                                    </div>
                                    <div class="form-group row">
