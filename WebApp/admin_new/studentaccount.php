<?php
      ...
      $query ="SELECT *FROM account WHERE is_approved=1 AND is_deleted=0 AND account_type='Student'";
      ...
      if (isset($_POST['search'])) {
          ...
          if (!empty(trim($find))) {
              $query = "SELECT *FROM account WHERE email='$find' AND is_approved=1 AND is_deleted=0";
              $result = mysqli_query($con,$query);
      ...
      if (isset($_GET['user_id'])) {
          ...
          $u_id = $_GET['user_id'];
          $query = "SELECT *FROM account WHERE id=$u_id AND is_approved=1 AND is_deleted=0 AND account_type='Student'";
              $result = mysqli_query($con,$query);
                  ...
                  <div class="col-md-6 grid-margin stretch-card">
                      <div class="card">
                          <div class="card-body">
                              ...
                              <form class="forms-sample" method="post" action="../php scripts/updateStudentAccount.php">
                                    <?php  if($msg ==505):?>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="full_name" class="form-control" id="exampleInputUsername2"  required value=<?php echo $full_name; ?>>
                                        </div>
                                    </div>
                                    <div class="form-group row">
