<?php
      ...
      if (isset($_GET['conlv_id'])) {
          $contl = $_GET['conlv_id'];

          $query = "SELECT * FROM student_level WHERE id =$contl LIMIT 1";
      ...
      if (mysqli_num_rows($result) > 0) {
          ...
          while ($rows = mysqli_fetch_assoc($result)) {
              ...
              $table.="<td>"."<a href='editstudentLevel.php?conlv_id=".$rows['id']."'><span class='mdi mdi-eyedropper ' style='color:green;font-size:14px;''> Edit</span></a>".
                      ...
                      <div class="card">
                          <div class="card-body">
                              ...
                              <form class="forms-sample" method="post" action="../php scripts/updatestudentLevel.php" enctype="multipart/form-data">
                                    ...
                                    <?php endif; ?>  
                                    <input type="hidden" name="cntl_id" value=<?php echo $p_id; ?>>
                                    ...
                                    <!-- <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="owner_name" class="form-control" id="exampleInputUsername2" placeholder="Owner of the note" required value=<?php echo $owner_name; ?>>
                                        </div>
                                    </div> -->
                                    
                                    
                                    <button type="submit" class="btn btn-gradient-primary mr-2" name="slc_upload">Update</button>
