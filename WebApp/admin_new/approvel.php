...
if (isset($_GET['msgs'])) {
    ...
    $query = "SELECT * FROM account WHERE id =$msgs LIMIT 1";
...
$table="";
$query = "SELECT *FROM account WHERE is_deleted=0 AND account_type='Student' AND is_approved=0";
$result = mysqli_query($con,$query);
...
if (mysqli_num_rows($result) > 0) {
    ...
    while ($rows = mysqli_fetch_assoc($result)) {
        ...
        $table.="<tr>";
        $table.="<td>".$rows['full_name']."</td>";
        $table.="<td>"."<a href='approvel.php?msgs=".$rows['id']."'><span class='mdi mdi-eyedropper ' style='color:green;font-size:14px;''> Approve</span></a>".
                ...
                <div class="col-md-6 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <br><br>
                            <form class="forms-sample" method="post" action="approvel.php" enctype="multipart/form-data">
                                <?php  if($msg ==505):?>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="name" class="form-control" id="exampleInputUsername2" placeholder="" required  value=<?php echo $stu_name; ?>>
                                    </div>
                                </div>
                                <div class="form-group row">
