<?php
      ...
      $query = "SELECT *FROM online_lessons ";
          ...
          <div class="content-wrapper">
            ...
            <div class="row">
                  <div class="col-md-6 grid-margin stretch-card">
                      <div class="card">
                          <div class="card-body">
                              <h4>Upload Online Lessons</h4><br><br>
                              <form class="forms-sample" method="post" action="../php scripts/addOnlineLesson.php" enctype="multipart/form-data">
                                    <?php  if($msg ==505):?>
                                        <div class="alert alert-success" role="alert">
                                              Online Lessons Added Successfully!.
                                        </div>
                                    <?php endif; ?> 
                                    
                                    <?php  if($msg ==507):?>
                                        <div class="alert alert-danger" role="alert">
                                              Unabe to add online lessons.
                                        </div>
                                    <?php endif; ?>  
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="lesson_name" class="form-control" id="exampleInputUsername2" placeholder="Lesson name" required >
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                          ...
                                          <div class="col-sm-9">
                                              <input type="text" name="lesson_link" class="form-control" id="exampleInputEmail2" placeholder="Online lesson link" required >
                                          </div>
                                    </div>
                                    <button type="submit" class="btn btn-gradient-primary mr-2" name="o_upload">Add</button>
