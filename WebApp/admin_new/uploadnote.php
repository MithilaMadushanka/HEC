          ...
          <div class="content-wrapper">
            ...
            <div class="row">
                  <div class="col-md-6 grid-margin stretch-card">
                      <div class="card">
                          <div class="card-body">
                              <h4 class="card-title">Upload Note Details</h4>
                              <!-- <p class="card-description"> Horizontal form layout </p> -->
                              <br><br>
                              <form class="forms-sample" method="post" action="../php scripts/uploadNote.php" enctype="multipart/form-data">
                                    <?php  if($msg ==505):?>
                                    ...
                                    <div class="form-group row">
                                          <label for="exampleInputMobile" class="col-sm-3 col-form-label">Note File</label>
                                          <div class="col-sm-9">
                                                <input type="file" name="note_file" class="form-control" id="exampleInputMobile" required  accept="application/pdf,.csv, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel">
                                          </div>
                                    </div>

                                    <button type="submit" class="btn btn-gradient-primary mr-2" name="n_upload">Upload</button>
