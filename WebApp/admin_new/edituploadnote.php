<?php
      ...
      if (isset($_GET['note_id'])) {
          ...
          $query = "SELECT * FROM notes WHERE id =$note_id LIMIT 1";
          ...
          <div class="content-wrapper">
            ...
            <div class="row">
                  <div class="col-md-6 grid-margin stretch-card">
                      <div class="card">
                          <div class="card-body">
                              <h4 class="card-title">Update Note Details</h4>
                              <!-- <p class="card-description"> Horizontal form layout </p> -->
                              <br><br>
                              <form class="forms-sample" method="post" action="../php scripts/updateNote.php" enctype="multipart/form-data">
                                    <?php  if($msg ==505):?>
                                    ...
                                    <?php endif; ?>  
                                    <input type="hidden" name="note_id" value=<?php echo $n_id; ?>>
                                    ...
                                    <button type="submit" class="btn btn-gradient-primary mr-2" name="un_upload">Update</button>
