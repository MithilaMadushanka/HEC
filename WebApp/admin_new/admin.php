<?php
      session_start();
      require_once('../php scripts/counter.php');
      ...
      $students = "";
      $no_of_notApproved=0;
      $query = "SELECT *FROM account WHERE is_approved=0 AND is_deleted=0 AND account_type='Student'";
          ...
          <ul class="navbar-nav navbar-nav-right">
            ...
            <li class="nav-item dropdown">
              <a class="nav-link count-indicator dropdown-toggle" id="notificationDropdown" href="#" data-toggle="dropdown">
                ...
                <?php echo "<sup class='text-danger font-weight-bold'>".$no_of_notApproved."</sup>"; ?>
              </a>
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="notificationDropdown">
                <h6 class="p-3 mb-0">Student approvels</h6>
                <div class="dropdown-divider"></div>
               
                <div class="dropdown-divider"></div>
                <?php for($i=0;$i<$no_of_notApproved;$i++): ?>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item preview-item" href="approvel.php?msgs=<?php echo $students['id'];?>">
                  ...
                  <div class="preview-item-content d-flex align-items-start flex-column justify-content-center">
                    <h6 class="preview-subject font-weight-normal mb-1"><?php echo $students['full_name']; ?></h6>
                    <p class="text-gray ellipsis mb-0"> <?php echo $students['email']; ?> </p>
                  </div>
                </a>
                <?php endfor; ?>
                  <a href=""><p class="text-center">View All</p></a>
              </div>
            </li>
            ...
            <div class="row" id="proBanner">
              <div class="col-12">
                <span class="d-flex align-items-center purchase-popup">
                  ...
                  <?php  if($msg ==505):?>
                      <div class="alert alert-success d-flex align-items-center purchase-popup bg-success text-white" role="alert" id="sus">
                          Student Account Approved Successfully!.
                      </div>
                  <?php endif; ?>
                  <?php  if($msg ==404):?>
                      <div class="alert alert-danger d-flex align-items-center purchase-popup bg-warning" role="alert">
                          Unable to Approve Student Account!
                      </div>
                  <?php endif; ?>
              </div>
            </div>
